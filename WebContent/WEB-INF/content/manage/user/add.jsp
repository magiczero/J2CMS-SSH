...
<body>
	<form name="frmAction" id="frmAction" method="post" action="save">
		...
		<input type="hidden" name="entity.group.id"  value="1"/>
		<input type="hidden" name="entity.checkState" value="pass" />
		<div id="main_frame">
			<div id="main_column">
										...
										<div class="statistics-body-order">
											...
											<table width="100%" border="0px;" cellpadding="0px;" cellspacing="2px;">
												...
												<tr>
													...
													<td colspan="2"><input name="entity.password" type="password" id="entity.password" size="30" value="${entity.password}" /> <span class="info1">&nbsp;*&nbsp;${message2}</span></td>
												</tr>
												<!--  
	<tr>
	...
	-->
												...
												<tr>
													...
													<td><input name="entity.address" type="text" id="entity.address" value="${entity.address}"  size="30" maxLength="100"/></td>
												</tr>
												<tr>
													<td height="25px" align="right">职务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
													<td colspan="2"><input name="entity.zipCode" type="text" id="entity.zipCode" value="${entity.zipCode}" size="30" maxLength="10"/></td>
												</tr>
