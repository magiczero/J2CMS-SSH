...
//	@Action(value="/manage",results={@Result(name = "success",location = "manage/manage.jsp")})
	@Action(value="/manage",results={@Result(name = "success",location = "manage/manage1.jsp")})
	public String manage(){
		//System.out.println("UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU");
		return SUCCESS;
	}
	
	@Action(value="/top1",results={@Result(name = "success",location = "manage/top1.jsp")})
	public String top(){
		return SUCCESS;
	}
	
	@Action(value="/left1",results={@Result(name = "success",location = "manage/left1.jsp")})
	public String left(){
		return SUCCESS;
	}
	
	@Action(value="/tools",results={@Result(name = "success",location = "manage/tools.jsp")})
	public String tools(){
		return SUCCESS;
	}
